...
import voidWeighting, analyzeNks
...
# maindir = '/fslhome/bch/cluster_expansion/vcmesh/semiconductors/sc_SiLP2'
...
#     jobFile.write("#SBATCH --qos=test\n")
    ...
    jobFile.write('python ~/pythonscripts/cluster_expansion/ceflashscripts/poscar2mesh.py {} {} {} > out\n'.format(ntarget,type,paramStr))

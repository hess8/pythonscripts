import sys
sys.path.append('/fslhome/bch/pymanopt/pymanopt/pymanopt')
sys.path.append('/fslhome/bch/pymanopt/pymanopt/pymanopt/tools')
sys.path.append('/fslhome/bch/pymanopt/pymanopt/pymanopt/tools/autodiff')
sys.path.append('/fslhome/bch/pymanopt/pymanopt/pymanopt/tools/autodiff/_autograd')
sys.path.append('/fslhome/bch/pymanopt/pymanopt/pymanopt/core')
import numpy as np

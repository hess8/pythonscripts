...
implicit none 
private
public test_compare_arbitrary_structures, is_derivative, is_equiv_lattice, is_lattice_point
...
subroutine test_compare_arbitrary_structures(LV1in,aTyp1in,ntypes1,aPos1in,natoms1,LV2in,aTyp2in,ntypes2,aPos2in,natoms2,&
                                     eps,mapped,status,irot,SMskipout,identical)
real(dp),intent(in):: LV1in(3,3), LV2in(3,3)    ! ! Lattice vectors for each structure
integer,intent(in):: natoms1, natoms2, ntypes1, ntypes2 !Number of atoms in each structure
real(dp),intent(in):: aPos1in(3,natoms1), aPos2in(3,natoms2)! ! Atomic positions for each structure
integer,intent(in) :: aTyp1in(ntypes1), aTyp2in(ntypes2)    ! ! Atom types for each structure
...
write(*,*) 'bch 244'
write(*,*) 'LV1in'; write(*,*) LV1in
write(*,*) 'aTyp1in'; write(*,*) aTyp1in
write(*,*) 'aPos1in'; write(*,*) aPos1in
write(*,*) 'LV2in'; write(*,*) LV2in
write(*,*) 'aTyp2in'; write(*,*) aTyp2in
write(*,*) 'aPos2in'; write(*,*) aPos2in
write(*,*) 'bch 248'
...
end subroutine test_compare_arbitrary_structures
